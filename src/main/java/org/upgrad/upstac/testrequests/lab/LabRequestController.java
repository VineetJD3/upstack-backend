...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        try{
            ...
            // Get and return Test Requests by the logged in User
            return testRequestQueryService.findByTester(loggedInUser);
        }catch (Error e){
            log.error("Error -- getForTester -- " + e.getMessage());
            throw new AppException("Error while getting Test Requests" + e);
        }finally {
            log.info("End -- getForTester");
        }
    }
